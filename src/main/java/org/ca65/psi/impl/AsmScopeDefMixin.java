...
public class AsmScopeDefMixin extends ASTWrapperPsiElement implements AsmLabelDefinition {
    public AsmScopeDefMixin(@NotNull ASTNode node) {
        super(node);
    }
