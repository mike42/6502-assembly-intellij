...
/** Shared mixin for both struct_def and union_def. */
public class AsmStructDefMixin extends ASTWrapperPsiElement implements AsmLabelDefinition {
    public AsmStructDefMixin(@NotNull ASTNode node) {
        super(node);
    }
