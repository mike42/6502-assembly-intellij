...
DOT_KEYWORD = "\." ( ADDR | ADDRSIZE | ALIGN | AND | ASCIIZ | ASIZE | ASSERT | AUTOIMPORT | BANK | BANKBYTE
                ...
                | ENDMAC | ENDMACRO | ENDREP | ENDREPEAT | ERROR
                ...
                | PAGELENGTH | PARAMCOUNT | PC02 | PDTV | POPCHARMAP | POPCPU | POPSEG | PSC02 | PUSHCHARMAP
                | PUSHCPU | PUSHSEG | REF | REFERENCED | RELOC | REPEAT | RES | RIGHT | RODATA | SEGMENT | SET
...
<YYINITIAL> {
    ...
    {SCOPE_KEYWORD}            {return SCOPE_KEYWORD;}
    {ENDSCOPE_KEYWORD}         {return ENDSCOPE_KEYWORD;}
    {PROC_KEYWORD}             {return PROC_KEYWORD;}
    {ENDPROC_KEYWORD}          {return ENDPROC_KEYWORD;}
