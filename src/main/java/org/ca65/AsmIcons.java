...
public class AsmIcons {
    ...
    public static final Icon SCOPE = IconLoader.getIcon("/icons/scope.svg", AsmIcons.class);
    public static final Icon PROC = IconLoader.getIcon("/icons/proc.svg", AsmIcons.class);
    ...
    public static final Icon JUMP_TO_PROC = IconLoader.getIcon("/icons/jumpToProc.svg", AsmIcons.class);
}
